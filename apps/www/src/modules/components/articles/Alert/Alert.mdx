...
<DemoCard>
  <Alert color="danger">Hello, I am an alert!</Alert>
</DemoCard>
...
`Alert`s accept a `color` prop which should be one of the _contextual_ colors (provided on the static property `Alert.COLORS`). This is a _subset_ of the design system [thematic colors](/core-style#theme-colors).
